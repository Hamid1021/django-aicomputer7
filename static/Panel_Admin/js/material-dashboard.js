...
(function() {
  ...
  if (isWindows) {
    ...
    if (document.getElementsByClassName('sidenav')[0]) {
      // var sidebar = document.querysidebarTypeSelector('.sidenav');
...
function sidebarColor(a) {
  ...
  const li = {
        "primary": "pr", "dark": "da", "info": "in", "success": "su", "warning": "wa", "danger": "dn",
  };
  xhttp.open("GET", '/site/admin/set_color_settings?color='+li[color]);
  xhttp.send();
...
function sidebarType(a) {
  ...
  const xhttp = new XMLHttpRequest();
  const li = {
        "bg-white": "wh", "bg-transparent": "tr", "bg-gradient-dark": "da",
  };
  xhttp.open("GET", '/site/admin/set_Sidenav_color_settings?color='+li[color]);
  xhttp.send();
  var colors = [];
...
function navbarFixed(el) {
  ...
  if (!el.getAttribute("checked")) {
    ...
    xhttp.open("GET", "/site/admin/set_fixed_navbar_settings?statue=True");
    xhttp.send();
  } else {
    ...
    xhttp.open("GET", "/site/admin/set_fixed_navbar_settings?statue=False");
    xhttp.send();
  }
}
...
function darkMode(el) {
  ...
  if (el.checked){
    xhttp.open("GET", "/site/admin/set_night_mode_settings?statue=True");
    xhttp.send();
    el.setAttribute("data-isDark", 1);
  }
  else {
    xhttp.open("GET", "/site/admin/set_night_mode_settings?statue=False");
    xhttp.send();
    el.setAttribute("data-isDark", 0);
    el.removeAttribute("checked");
  }
  var is_dark = (el.getAttribute("data-isDark") === '1');
  if (is_dark) {
